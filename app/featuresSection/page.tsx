...
export default function FeaturesSection() {
  const features = [
    {
      icon: "/fi_7178653.svg",
      title: "Trajets existants",
      description: "S'appuyer sur des trajets déjà existants pour une livraison plus humaine, économique et respectueuse de l'environnement."
    },
    {
      icon: "/fi_1728563.svg",
      title: "Tarifs justes",
      description: "Des prix transparents et justes pour des envois accessibles à tous."
    },
    {
      icon: "/Group 39694.svg",
      title: "Livraison humaine",
      description: "Une solution collaborative pensée pour les besoins réels des utilisateurs."
    }
  ];
